...
function p(
  ...
  return {
    ...
    description,
    category,
    images: images.map((url) => optimizeImageUrl(url, IMAGE_WIDTHS.card)),
    price,
    original_price,
    discount,
    sizes,
...
export const DEMO_CATEGORIES: Category[] = [
  { id: 'demo-cat-t-shirts', slug: 't-shirts', name: 'T-Shirts', image: optimizeImageUrl('https://images.pexels.com/photos/1656684/pexels-photo-1656684.jpeg', IMAGE_WIDTHS.category), status: 'active' },
  { id: 'demo-cat-hoodies', slug: 'hoodies', name: 'Hoodies', image: optimizeImageUrl('https://images.pexels.com/photos/6311662/pexels-photo-6311662.jpeg', IMAGE_WIDTHS.category), status: 'active' },
  { id: 'demo-cat-caps', slug: 'caps', name: 'Caps', image: optimizeImageUrl('https://images.pexels.com/photos/1124465/pexels-photo-1124465.jpeg', IMAGE_WIDTHS.category), status: 'active' },
  { id: 'demo-cat-mobile-covers', slug: 'mobile-covers', name: 'Mobile Covers', image: optimizeImageUrl('https://images.pexels.com/photos/3781338/pexels-photo-3781338.jpeg', IMAGE_WIDTHS.category), status: 'active' },
  { id: 'demo-cat-posters', slug: 'posters', name: 'Posters', image: optimizeImageUrl('https://images.pexels.com/photos/1666320/pexels-photo-1666320.jpeg', IMAGE_WIDTHS.category), status: 'active' },
];

export const DEMO_BANNERS: Banner[] = [
  { id: 'demo-banner-1', title: 'New Season Drop — FW Limited Edition', image: optimizeImageUrl('https://images.pexels.com/photos/1884581/pexels-photo-1884581.jpeg', IMAGE_WIDTHS.hero), link: '/shop', active: true },
  { id: 'demo-banner-2', title: 'Everyday Elevated — Premium Essentials', image: optimizeImageUrl('https://images.pexels.com/photos/1183266/pexels-photo-1183266.jpeg', IMAGE_WIDTHS.hero), link: '/shop?cat=t-shirts', active: true },
  { id: 'demo-banner-3', title: 'Art You Can Wear — Poster Series Vol. 02', image: optimizeImageUrl('https://images.pexels.com/photos/3781338/pexels-photo-3781338.jpeg', IMAGE_WIDTHS.hero), link: '/shop?cat=posters', active: true },
];

export const DEMO_PRODUCTS: Product[] = [
  p('monochrome-oversized-tee', 'Monochrome Oversized Tee', 'A heavyweight 240gsm cotton tee with a boxy, structured silhouette. Garment-dyed for depth and soft hand feel.', 't-shirts', ['https://images.pexels.com/photos/1656684/pexels-photo-1656684.jpeg', 'https://images.pexels.com/photos/1043474/pexels-photo-1043474.jpeg', 'https://images.pexels.com/photos/8217423/pexels-photo-8217423.jpeg'], 1499, 2299, 35, ['S', 'M', 'L', 'XL', 'XXL'], ['Black', 'White', 'Storm Grey'], 3, 120, 'MHF-TS-001', ['oversized', 'cotton', 'unisex'], 4.7, 128, true, true, true),
  p('atelier-boxy-tee', 'Atelier Boxy Tee', 'Minimal boxy fit crew in pima cotton with a soft brushed interior and dropped shoulders.', 't-shirts', ['https://images.pexels.com/photos/1043474/pexels-photo-1043474.jpeg', 'https://images.pexels.com/photos/1656684/pexels-photo-1656684.jpeg', 'https://images.pexels.com/photos/1488463/pexels-photo-1488463.jpeg'], 1299, 1899, 32, ['XS', 'S', 'M', 'L', 'XL'], ['Sand', 'Olive', 'Black'], 3, 90, 'MHF-TS-002', ['boxy', 'minimal'], 4.5, 64, false, true, true),
  ...
  p('essential-heavycrew', 'Essential Heavy-Crew Tee', 'Our everyday hero: 220gsm ringspun cotton, ribbed collar, side-seamed body.', 't-shirts', ['https://images.pexels.com/photos/162079/pexels-photo-162079.jpeg', 'https://images.pexels.com/photos/1656684/pexels-photo-1656684.jpeg', 'https://images.pexels.com/photos/1043474/pexels-photo-1043474.jpeg'], 999, 1599, 38, ['XS', 'S', 'M', 'L', 'XL', 'XXL'], ['Black', 'White', 'Storm Grey', 'Navy'], 4, 200, 'MHF-TS-005', ['essential', 'cotton', 'everyday'], 4.8, 210, true, true, true),
  ...
  p('archive-zip-hoodie', 'Archive Zip Hoodie', 'Half-zip archival hoodie with side panels for movement and brushed interior warmth.', 'hoodies', ['https://images.pexels.com/photos/8217423/pexels-photo-8217423.jpeg', 'https://images.pexels.com/photos/6311662/pexels-photo-6311662.jpeg', 'https://images.pexels.com/photos/1183266/pexels-photo-1183266.jpeg'], 2699, 3899, 31, ['S', 'M', 'L', 'XL'], ['Olive', 'Black', 'Camel'], 3, 65, 'MHF-HD-002', ['zip', 'archive'], 4.6, 58, false, true, true),
  ...
  p('signature-structured-cap', 'Signature Structured Cap', 'Six-panel structured cap with embroidered monogram and curved peak.', 'caps', ['https://images.pexels.com/photos/1124465/pexels-photo-1124465.jpeg', 'https://images.pexels.com/photos/3511289/pexels-photo-3511289.jpeg', 'https://images.pexels.com/photos/1840971/pexels-photo-1840971.jpeg'], 899, 1299, 31, ['One Size'], ['Black', 'Navy', 'White'], 3, 150, 'MHF-CP-001', ['structured', 'embroidered'], 4.6, 76, true, true, true),
  p('heritage-snapback', 'Heritage Snapback', 'Flat-brim snapback with seven-row stitching and woven side label.', 'caps', ['https://images.pexels.com/photos/1840971/pexels-photo-1840971.jpeg', 'https://images.pexels.com/photos/7679471/pexels-photo-7679471.jpeg', 'https://images.pexels.com/photos/1124465/pexels-photo-1124465.jpeg'], 999, 1499, 33, ['One Size'], ['Black', 'Olive', 'Sand'], 3, 90, 'MHF-CP-002', ['snapback', 'heritage'], 4.5, 41, false, false, true),
  p('minimal-cord-cap', 'Minimal Cord Cap', 'Six-panel corduroy unstructured cap with a soft curved brim.', 'caps', ['https://images.pexels.com/photos/3511289/pexels-photo-3511289.jpeg', 'https://images.pexels.com/photos/3193664/pexels-photo-3193664.jpeg', 'https://images.pexels.com/photos/1840971/pexels-photo-1840971.jpeg'], 849, 1199, 29, ['One Size'], ['Camel', 'Forest', 'Maroon'], 3, 110, 'MHF-CP-003', ['corduroy', 'minimal'], 4.4, 35, false, true, false),
  p('trucker-mesh-cap', 'Trucker Mesh Cap', 'Foam-front, mesh-back trucker cap with adjustable snap closure.', 'caps', ['https://images.pexels.com/photos/7679471/pexels-photo-7679471.jpeg', 'https://images.pexels.com/photos/3193664/pexels-photo-3193664.jpeg', 'https://images.pexels.com/photos/3511289/pexels-photo-3511289.jpeg'], 799, 1099, 27, ['One Size'], ['Black', 'White', 'Storm Grey'], 3, 180, 'MHF-CP-004', ['trucker', 'mesh'], 4.3, 28, false, false, false),
